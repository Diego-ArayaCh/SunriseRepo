...
namespace Infraestructure
{
    public class Log
    {
        ...
        public static void Error(System.Exception exception, MethodBase methodBase, ref
       string pMensaje)
        {
            ...
            {
                msg.AppendFormat("{0}\n", DbException(exception as DbUpdateException,
               methodBase, ref pMensaje));
            ...
            else
            {
                ...
                {
                    msg.AppendFormat("{0}\n", GetDetailsSQLException(exception as
                   SqlException));
                    msg.AppendFormat("{0}\n", GetCustomErrorByNumber(exception as
                   SqlException));
            ...
            if (pDbUpdateException.InnerException != null)
            {
               ...
               (UpdateException)pDbUpdateException.InnerException;
                if (updateException.InnerException != null)
                {
                   ...
                   (SqlException)updateException.InnerException;
